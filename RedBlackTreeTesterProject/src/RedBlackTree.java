...
public class RedBlackTree {
	...
	/**
	 * Get recent comparing number Post-condition: a integer number is returned
	 * BigTheta: 1
	 * 
	...
	public void inOrderTraversal(RedBlackNode t) {
		/*
		 * Can also use toString, but just to verify they are same
		 */
	...
	public void insert(String value) {
		RedBlackNode x = root, y = nil, z = new RedBlackNode(value, 1, nil,
				nil, nil);
		while (x != nil) {
			y = x;
	 ...
	 * 
	 * @param args
	 *            arguments of the main method, no command line arguments
	 */
